...
<html lang="en">
    ...
    <body id="page-top">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col auto">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                        $sql = "SELECT COUNT(DISTINCT(sf.customer_id)) customer FROM fact_sales sf JOIN time_dimens t ON sf.time_id = t.time_id WHERE t.tahun=2001";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col auto">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                        $sql = "SELECT AVG(sub_total) as avg FROM fact_sales";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
        ...
        <script type="text/javascript">
            ...
            $customer = "SELECT COUNT(DISTINCT(sf.customer_id)) as customer FROM fact_sales sf JOIN time_dimens t on t.time_id = sf.time_id GROUP BY t.tahun";
            $i=1;
        ...
        <script type="text/javascript">
            ...
            $amount1 = "SELECT COUNT(DISTINCT(sf.customer_id)) as customer FROM fact_sales sf JOIN time_dimens t on t.time_id = sf.time_id WHERE t.tahun = 2004 GROUP BY t.bulan";
            $amount2 = "SELECT COUNT(DISTINCT(sf.customer_id)) as customer FROM fact_sales sf JOIN time_dimens t on t.time_id = sf.time_id WHERE t.tahun = 2003 GROUP BY t.bulan";
            $amount3 = "SELECT COUNT(DISTINCT(sf.customer_id)) as customer FROM fact_sales sf JOIN time_dimens t on t.time_id = sf.time_id WHERE t.tahun = 2002 GROUP BY t.bulan";
            $i=1;
